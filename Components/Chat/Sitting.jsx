...
const Sitting = () =>{
  ...
  return (
   ...
   <input type="email" id="firstname" placeholder={user?.name}
   ...
   <input type="email" id="lastname" placeholder={user?.name}
   ...
   <input type="email" id="emailid" placeholder={user?.name}
   ...
   {/* //SECOND COMPONENT */}
   {
    ...
    :""
      ...
      <input type="email" id="lastname" placeholder={
        userMembership.membershipId ==1 ? "1 Matic"
    ...
    :""
      ...
      <input type="email" id="emailid" placeholder={
        userMembership.id
      }
      className="msger-input"
      />
      ...
      <input type="email" id="emailid" placeholder={`${userMembership.expiredate
        || ""}`}
      className="msger-input"
      />
    ...
    Address
      ...
      <input type="email" id="emailid" placeholder={userMembership.addressUser}
      className="msger-input"
      />
   ...
   <input type="email" id="lastname" placeholder={`Confirm password`}
