...
export const handleSubmit = async (e) => {
    ...
    const response = await fetch("http://localhost:4000", {  // Ensure this matches the server port
        method: "POST",
        headers: {
    ...
    if (response.ok) {
        ...
        const parsedData = data.message.trim();  // Adjusted to use the correct property from your server response
        ...
        messageDiv.innerHTML = "Something went very wrong, Reload the page";
        alert(error);
    }
};
